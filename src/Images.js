    ...
    return (
        <>
            <div className='container'>
                <div data-aos="fade-right" className='div'><img src='https://images.unsplash.com/photo-1682684123154-c21854fd90cf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' alt='Description of the img'></img></div>
                ...
                <div data-aos="fade-up" className='div'><img src='https://images.unsplash.com/photo-1682687982183-c2937a74257c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxMXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60' alt='Description of the img'></img></div>
                <div data-aos="flip-left" className='div'><img src='https://images.unsplash.com/photo-1682956101601-b4b76b162d18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzM3x8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60' alt='Description of the img'></img></div>
                ...
                <div data-aos="zoom-in-left" className='div'><img src='https://images.unsplash.com/photo-1682603812564-88b0a2896682?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw3Nnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60' alt='Description of the img'></img></div>
            </div>
        </>
    )
}
